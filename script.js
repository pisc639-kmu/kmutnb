    ...
    <span>
        ...
        <nav class="border-b border-zinc-700 border-zinc p-4 sticky top-0 z-50 transition-colors duration-300 dark bg-gray-50 dark:bg-gray-950">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <!-- <div class="hidden md:space-x-8 md:flex flex items-center justify-center space-x-4 font-medium transition-colors">
                    ...
                    <a href="../summary" class="text-zinc-600 dark:text-zinc-300 hover:text-blue-500 dark:hover:text-blue-400 duration-300 rounded-md py-2 px-3 hover:bg-zinc-200 dark:hover:bg-zinc-700">Summary</a>
                </div> -->
                <div class="hidden md:space-x-8 md:flex flex items-center justify-center space-x-4 font-medium transition-colors">
                    ...
                    <a href="https://kmu.pisc.cc/summary" class="text-zinc-600 dark:text-zinc-300 hover:text-blue-500 dark:hover:text-blue-400 duration-300 rounded-md py-2 px-3 hover:bg-zinc-200 dark:hover:bg-zinc-700">Summary</a>
                </div>
            </div>
        </nav>
        ...
        <div id="mobile-menu" class="hidden md:hidden shadow-md rounded-md m-4 transition-all duration-300 ease-in-out bg-zinc-100 dark:bg-zinc-800">
            ...
            ">
                ...
                <a href="../summary" class="bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-zinc-600 dark:text-zinc-300 hover:text-blue-500 dark:hover:text-blue-400 font-medium transition-colors duration-300 rounded-md py-2 px-3">Summary</a>
            </div>
        </div>
    <span>
    `
